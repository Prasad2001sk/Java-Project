...
public class quiz extends JFrame implements ActionListener 
{
    ...
    public quiz(String username){
        ...
        qno.setBounds(100,150,400,100);
        add(qno);
        
        question = new JLabel("");
        question.setFont(new Font("Tahoma", Font.PLAIN,16));
        question.setBounds(120,150,650,100);
        add(question);
        ...
        lifeline.setBounds(550,300,150,30);
        ...
        submit.setBounds(550,260,150,30);
        add(submit);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == next){
            ...
            new scores(username, score).setVisible(true);
        }
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time,500,450);
        }else {
            g.drawString("Times Up!!",500,450);
        }
